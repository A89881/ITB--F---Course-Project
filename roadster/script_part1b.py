...
# Create an array of 10000 points between 0 and the last distance of each route
x1 = np.linspace(0, distance_km1[-1], 10000)
v1 = roadster.velocity(x1, source_file_1)

x2 = np.linspace(0, distance_km2[-1], 10000)
v2 = roadster.velocity(x2, source_file_2)
